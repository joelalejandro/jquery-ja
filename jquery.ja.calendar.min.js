...
return dReturn;}})();(function(){Date.prototype.toDayMonthYearDate=function()
...
return;if(dateDiff<settings.minRangeLength-1&&settings.minRangeLength!=-1)
return;for(var i=fromIndex;i<=toIndex;i++)
{if(!$($days[i]).hasClass("selectable")||d>=settings.maxRangeLength)
{break;}
$($days[i]).addClass("selected");d++;}
$calendar.data("selectedDate.jaCalendar",{from:fromDate,to:$($days[i]).data("date")});$calendar.trigger("selectedRangeChanged");}
break;}
